...
export default async function HomeSurfacePage({ searchParams }: { searchParams?: SearchParams }) {
  return await ProductSurfacePage({
    ...
    brief: [
      ...
      "Authenticated clients can choose Chat-first as their default landing behavior.",
      "Review the current business context, then continue to Chat, Offers, Asks, or Latest.",
