...
const staffScreens: Record<string, MemberScreen> = {
  today: {
    ...
    main: [
      { meta: "Trial", title: "Join Maya's trial signup thread", detail: "A meetup QR visitor is ready to start the 30-day trial and asked for Keith while he is online.", action: "Claim handoff" },
  ...
  handoffs: {
    ...
    stage: "2 waiting",
    primaryAction: "Claim a handoff only when you are ready to help.",
    ...
    main: [
      { meta: "Trial", title: "Claim Maya's trial signup handoff", detail: "A meetup QR visitor is ready to start the 30-day trial and asked for Keith while he is online.", action: "Claim handoff" },
