...
export const memberWorkItems: readonly MemberWorkItem[] = [
  ...
  },
  {
    ...
    kind: "request",
    title: "Share private trial feedback",
    ...
    actions: [
      { kind: "reply", label: "Respond in Ordo", href: "/my/chat?notice=private-feedback-request", primary: true },
  ...
  },
  {
    ...
    primaryRoom: "offers",
    kind: "offer",
    title: "Hosted 30-day trial accepted",
